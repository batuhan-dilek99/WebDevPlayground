...
class Brutus:
    ...
    def cracker(self, text):
        ...
        for k in range(1, self.keySpace):
            ...
            #print("-------------------------------")
        #print("Key probs : " + str(keyProbs))
        print("Calculating the best keys[ ]")
        ...
        for k in possibleKeys:
            ...
            last = "".join(tmpList)
            print("Key : " + str(k) + " Encrypted message : " + last)
